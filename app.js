...
// regular expression for validation by {Shivam Shishodia}
...
let addrName = firstName = lastName = email = phone =   city = country = labels = "";

class Address{
    constructor(id, addrName, firstName, lastName, email, phone, city, country, labels){
        this.id = id;
...
class UI{
    ...
    static addToAddressList(address){
        ...
        tableRow.innerHTML = `
            <td>${address.id}</td>
            <td>
                <span class = "addressing-name">${address.addrName}</span><br><span class = "address"> ${address.city} ${address.country}</span>
            </td>
    ...
    modalBtns.addEventListener('click', (event) => {
        ...
        if(event.target.id == "save-btn"){
            ...
            if(!isFormValid){
                ...
                const addressItem = new Address(lastItemId, addrName, firstName, lastName, email, phone , city, country, labels);
    ...
    modalBtns.addEventListener('click', (event) => {
        ...
        if(event.target.id == "update-btn"){
            ...
            if(!isFormValid){
                ...
                const addressItem = new Address(id, addrName, firstName, lastName, email, phone, city, country, labels);
